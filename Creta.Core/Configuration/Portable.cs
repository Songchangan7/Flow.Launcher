...
namespace Creta.Core.Configuration
{
    public class Portable : IPortable
    {
        ...
        public void CreateUninstallerEntry()
        {
            ...
            using (var subKey2 = subKey1.CreateSubKey(Constant.Creta, RegistryKeyPermissionCheck.ReadWriteSubTree))
            {
