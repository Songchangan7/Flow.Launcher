...
namespace Flow.Launcher.Plugin
{
    ...
    /// </summary>
    /// <param name="e"></param>
    public delegate void CretaKeyDownEventHandler(CretaKeyDownEventArgs e);

    /// <summary>
    /// Delegate for query event
    /// </summary>
    /// <param name="e"></param>
    public delegate void AfterCretaQueryEventHandler(CretaQueryEventArgs e);
    ...
    public delegate bool CretaGlobalKeyboardEventHandler(int keyevent, int vkcode, SpecialKeyState state);
    ...
    /// </summary>
    public class CretaKeyDownEventArgs
    {
        /// <summary>
        /// The actual query
        /// </summary>
    ...
    /// </summary>
    public class CretaQueryEventArgs
    {
        /// <summary>
        /// The actual query
        /// </summary>
