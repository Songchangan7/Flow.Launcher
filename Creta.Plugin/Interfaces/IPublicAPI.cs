...
namespace Flow.Launcher.Plugin
{
    ...
    public interface IPublicAPI
    {
        ...
        /// <param name="requery">
        /// Force requery. By default, Creta will not fire query if your query is same with existing one.
        /// Set this to <see langword="true"/> to force Creta re-querying
        /// </param>
        ...
        /// <summary>
        /// Save everything, all of Creta and plugins' data and settings
        /// </summary>
        ...
        /// <summary>
        /// Requests Creta to restore focus to the window that was in the foreground
        ...
        /// <summary>
        /// Get the current plugin manifest entries known to Creta.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Get the user data directory of Creta.
        /// </summary>
        /// <returns></returns>
        string GetDataDirectory();

        /// <summary>
        /// Get the log directory of Creta.
        /// </summary>
        /// <returns></returns>
