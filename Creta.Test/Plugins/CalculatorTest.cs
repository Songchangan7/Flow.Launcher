    ...
    public class CalculatorPluginTest
    {
        ...
        public CalculatorPluginTest()
        {
            ...
            if (settingField == null)
                Assert.Fail("Could not find field '_settings' on Creta.Plugin.Calculator.Main");
            ...
            if (engineField == null)
                Assert.Fail("Could not find static field 'MagesEngine' on Creta.Plugin.Calculator.Main");
        ...
        {
            var results = _plugin.Query(new Flow.Launcher.Plugin.Query()
            {
                Search = expression
            });
