...
using Creta.Core;
using Creta.Core.Configuration;
using Creta.Core.ExternalPlugins.Environments;
using Creta.Core.Plugin;
using Creta.Core.Resource;
using Creta.Helper;
using Creta.Infrastructure;
using Creta.Infrastructure.Http;
using Creta.Infrastructure.Image;
...
namespace Creta
{
    public partial class App : IDisposable, ISingleInstanceApp
    {
        ...
        public App()
        {
            ...
            try
            {
                var host = Host.CreateDefaultBuilder()
                    ...
                    .ConfigureServices(services => services
                        ...
                        .AddSingleton(sp => new Updater(sp.GetRequiredService<IPublicAPI>(), Creta.Properties.Settings.Default.GithubRepo))
            ...
            {
                ShowErrorMsgBoxAndFailFast("Cannot configure dependency injection container, please open new issue in Creta", e);
                return;
            }
            ...
            {
                ShowErrorMsgBoxAndFailFast("Cannot initialize api and settings, please open new issue in Creta", e);
                return;
            }
        }
        ...
        public static void Main()
        {
            ...
            try
            {
                var storage = new CretaJsonStorage<Settings>();
...
#pragma warning disable VSTHRD100 // Avoid async void methods
        ...
        private async void OnStartup(object sender, StartupEventArgs e)
        {
            await API.StopwatchLogInfoAsync(ClassName, "Startup cost", async () =>
            {
                ...
                API.LogInfo(ClassName, "Begin Creta startup ----------------------------------------------------");
                ...
                Current.MainWindow.Title = Constant.Creta;
                ...
                API.LogInfo(ClassName, "End Creta startup ------------------------------------------------------");
...
#pragma warning restore VSTHRD100 // Avoid async void methods
        ...
        private static void AutoStartup()
        {
            ...
            if (_settings.StartCretaOnSystemStartup)
            {
                try
                {
                ...
                catch (Exception e)
                {
                    ...
                    _settings.StartCretaOnSystemStartup = false;
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            {
                API.LogInfo(ClassName, "Begin Creta dispose ----------------------------------------------------");
                ...
                API.LogInfo(ClassName, "End Creta dispose ----------------------------------------------------");
            });
        }
