...
#pragma warning restore VSTHRD100 // Avoid async void methods
        ...
        private void InitializeContextMenu()
        {
            ...
            open.Click += (o, e) => _viewModel.ToggleCreta();
        ...
        {
            // Initialize call twice to workaround multi-display alignment issue- https://github.com/Songchangan7/creta/issues/2910
            if (_viewModel.IsDialogJumpWindowUnderDialog())
            {
