...
namespace Creta.SettingPages.ViewModels;
...
public partial class SettingsPaneThemeViewModel : BaseModel
{
    ...
    public static string LinkHowToCreateTheme => @"https://www.creta.com/theme-builder/";
    public static string LinkThemeGallery => "https://github.com/Songchangan7/creta/discussions/1438";
        ...
        var results = new List<Result>
            {
                new()
                {
                    ...
                    IcoPath = Path.Combine(
                        ...
                        @"Plugins\Creta.Plugin.BrowserBookmark\Images\explorer.png"
                    )
                },
                new()
                {
                    ...
                    IcoPath = Path.Combine(
                        Constant.ProgramDirectory,
                        @"Plugins\Creta.Plugin.BrowserBookmark\Images\web_search.png"
                    )
                },
                new()
                {
                    ...
                    IcoPath = Path.Combine(
                        Constant.ProgramDirectory,
                        @"Plugins\Creta.Plugin.BrowserBookmark\Images\program.png"
                    )
                },
                new()
                {
                    ...
                    IcoPath = Path.Combine(
                        Constant.ProgramDirectory,
                        @"Plugins\Creta.Plugin.BrowserBookmark\Images\app.png"
                    )
                }
            };
