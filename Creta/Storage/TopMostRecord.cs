...
namespace Creta.Storage
{
    public class CretaJsonStorageTopMostRecord
    {
        private readonly CretaJsonStorage<MultipleTopMostRecord> _topMostRecordStorage;
        private readonly MultipleTopMostRecord _topMostRecord;

        public CretaJsonStorageTopMostRecord()
        {
#pragma warning disable CS0618 // Type or member is obsolete
            // Get old data & new data
            var topMostRecordStorage = new CretaJsonStorage<TopMostRecord>();
#pragma warning restore CS0618 // Type or member is obsolete
            _topMostRecordStorage = new CretaJsonStorage<MultipleTopMostRecord>();
