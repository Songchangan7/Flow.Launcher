...
using Creta.Plugin.Explorer.Search.DirectoryInfo;
using Creta.Plugin.Explorer.Search.Everything;
using Creta.Plugin.Explorer.Search.QuickAccessLinks;
using Flow.Launcher.Plugin.SharedCommands;
using static Creta.Plugin.Explorer.Settings;
using Path = System.IO.Path;

namespace Creta.Plugin.Explorer.Search
{
    public class SearchManager
    {
        ...
        private List<Result> EverythingContentSearchResult(Query query)
        {
            ...
            [
                new()
                {
                    Title = Localize.creta_plugin_everything_enable_content_search(),
                    SubTitle = Localize.creta_plugin_everything_enable_content_search_tips(),
