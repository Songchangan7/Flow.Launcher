...
using Creta.Plugin.Explorer.Helper;
using Creta.Plugin.Explorer.Search;
using Creta.Plugin.Explorer.Search.Everything;
using Creta.Plugin.Explorer.Search.Everything.Exceptions;
using Creta.Plugin.Explorer.Search.QuickAccessLinks;
using Creta.Plugin.Explorer.Views;

namespace Creta.Plugin.Explorer.ViewModels
{
            ...
            get
            {
                try
                {
                    ...
                    return EverythingApi.IsFastSortOption(Settings.SortOption) ? string.Empty
                        : Localize.creta_plugin_everything_nonfastsort_warning();
                }
                catch (IPCErrorException)
                {
                    return Localize.creta_plugin_everything_is_not_running();
                }
                catch (DllNotFoundException)
                {
                    return Localize.creta_plugin_everything_sdk_issue();
                }
            }
        }
