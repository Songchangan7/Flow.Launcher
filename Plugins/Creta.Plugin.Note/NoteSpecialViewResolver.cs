    ...
    internal static NoteSpecialView Resolve(string trimmedContent, NoteRepository repository, int browseNotesLimit)
    {
        if (NoteSpecialViewKeywords.IsAll(trimmedContent))
        {
            ...
            return new NoteSpecialView
            {
                ...
                Title = Localize.creta_plugin_note_special_all_title(),
                Subtitle = Localize.creta_plugin_note_special_all_subtitle(notes.Count),
                Notes = notes
            };
        }
        ...
        if (NoteSpecialViewKeywords.IsPinned(trimmedContent))
        {
            ...
            return new NoteSpecialView
            {
                ...
                Title = Localize.creta_plugin_note_special_pinned_title(),
                Subtitle = Localize.creta_plugin_note_special_pinned_subtitle(notes.Count),
                Notes = notes
            };
        }
        ...
        if (NoteSpecialViewKeywords.IsToday(trimmedContent))
        {
            ...
            return new NoteSpecialView
            {
                ...
                Title = Localize.creta_plugin_note_special_today_title(),
                Subtitle = Localize.creta_plugin_note_special_today_subtitle(notes.Count),
                Notes = notes
            };
        }
        ...
        if (NoteSpecialViewKeywords.IsWeek(trimmedContent))
        {
            ...
            return new NoteSpecialView
            {
                ...
                Title = Localize.creta_plugin_note_special_week_title(),
                Subtitle = Localize.creta_plugin_note_special_week_subtitle(notes.Count),
                Notes = notes
            };
        }
        ...
        if (NoteSpecialViewKeywords.IsRecent(trimmedContent))
        {
            ...
            return new NoteSpecialView
            {
                ...
                Title = Localize.creta_plugin_note_special_recent_title(),
                Subtitle = Localize.creta_plugin_note_special_recent_subtitle(notes.Count),
                Notes = notes
            };
        }
        ...
        if (NoteSpecialViewKeywords.IsArchived(trimmedContent))
        {
            ...
            return new NoteSpecialView
            {
                ...
                Title = Localize.creta_plugin_note_special_archived_title(),
                Subtitle = Localize.creta_plugin_note_special_archived_subtitle(notes.Count),
                Notes = notes
            };
        }
        ...
        if (trimmedContent.StartsWith("tag ", System.StringComparison.OrdinalIgnoreCase))
        {
            ...
            return new NoteSpecialView
            {
                ...
                Title = Localize.creta_plugin_note_special_tag_title(tag),
                Subtitle = Localize.creta_plugin_note_special_tag_subtitle(tag, notes.Count),
                Notes = notes
            };
        }
