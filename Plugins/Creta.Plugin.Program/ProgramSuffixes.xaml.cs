...
namespace Creta.Plugin.Program
{
    public partial class ProgramSuffixes
    {
        ...
        private void BtnAdd_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                string warning = context.API.GetTranslation("creta_plugin_program_suffixes_cannot_empty");
            ...
            {
                string warning = context.API.GetTranslation("creta_plugin_protocols_cannot_empty");
                context.API.ShowMsgBox(warning);
                return;
            }
