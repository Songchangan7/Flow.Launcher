...
namespace Creta.Plugin.Sys
{
    public class Main : IPlugin, ISettingProvider, IPluginI18n
    {
        ...
        {
            {"Shutdown", "creta_plugin_sys_shutdown_computer_cmd"},
            {"Restart", "creta_plugin_sys_restart_computer_cmd"},
            {"Restart With Advanced Boot Options", "creta_plugin_sys_restart_advanced_cmd"},
            {"Log Off/Sign Out", "creta_plugin_sys_log_off_cmd"},
            {"Lock", "creta_plugin_sys_lock_cmd"},
            {"Sleep", "creta_plugin_sys_sleep_cmd"},
            {"Hibernate", "creta_plugin_sys_hibernate_cmd"},
            {"Index Option", "creta_plugin_sys_indexoption_cmd"},
            {"Empty Recycle Bin", "creta_plugin_sys_emptyrecyclebin_cmd"},
            {"Open Recycle Bin", "creta_plugin_sys_openrecyclebin_cmd"},
            {"Exit", "creta_plugin_sys_exit_cmd"},
            {"Save Settings", "creta_plugin_sys_save_all_settings_cmd"},
            {"Restart Creta", "creta_plugin_sys_restart_cmd"},
            {"Settings", "creta_plugin_sys_setting_cmd"},
            {"Reload Plugin Data", "creta_plugin_sys_reload_plugin_data_cmd"},
            {"Check For Update", "creta_plugin_sys_check_for_update_cmd"},
            {"Open Log Location", "creta_plugin_sys_open_log_location_cmd"},
            {"Creta Tips", "creta_plugin_sys_open_docs_tips_cmd"},
            {"Creta UserData Folder", "creta_plugin_sys_open_userdata_location_cmd"},
            {"Toggle Game Mode", "creta_plugin_sys_toggle_game_mode_cmd"},
            {"Set Creta Theme", "creta_plugin_sys_theme_selector_cmd"}
        };
        ...
        private const string Documentation = "https://creta.com/docs/#/usage-tips";
            ...
            [
                    ...
                    Action = c =>
                    {
                        var result = _settings.SkipPowerActionConfirmation
                            ...
                            : Context.API.ShowMsgBox(
                                Localize.creta_plugin_sys_dlgtext_shutdown_computer(),
                                Localize.creta_plugin_sys_shutdown_computer(),
                ...
                new Result
                {
                    ...
                    Action = c =>
                    {
                        var result = _settings.SkipPowerActionConfirmation
                            ? MessageBoxResult.Yes
                            : Context.API.ShowMsgBox(
                                Localize.creta_plugin_sys_dlgtext_restart_computer(),
                                Localize.creta_plugin_sys_restart_computer(),
                                MessageBoxButton.YesNo, MessageBoxImage.Warning);
                ...
                new Result
                {
                    ...
                    Action = c =>
                    {
                        var result = _settings.SkipPowerActionConfirmation
                            ? MessageBoxResult.Yes
                            : Context.API.ShowMsgBox(
                                Localize.creta_plugin_sys_dlgtext_restart_computer_advanced(),
                                Localize.creta_plugin_sys_restart_computer(),
                                MessageBoxButton.YesNo, MessageBoxImage.Warning);
                ...
                new Result
                {
                    ...
                    Action = c =>
                    {
                        var result = _settings.SkipPowerActionConfirmation
                            ? MessageBoxResult.Yes
                            : Context.API.ShowMsgBox(
                                Localize.creta_plugin_sys_dlgtext_logoff_computer(),
                                Localize.creta_plugin_sys_log_off(),
                                MessageBoxButton.YesNo, MessageBoxImage.Warning);
                ...
                new Result
                {
                    ...
                    Action = c =>
                    {
                        ...
                        {
                            Context.API.ShowMsgBox(
                                Localize.creta_plugin_sys_dlgtext_empty_recycle_bin_failed(Environment.NewLine),
                                Localize.creta_plugin_sys_dlgtitle_error(),
                ...
                new Result
                {
                    ...
                    {
                        Context.API.SaveAppAllSettings();
                        Context.API.ShowMsg(Localize.creta_plugin_sys_dlgtitle_success(),
                            Localize.creta_plugin_sys_dlgtext_all_settings_saved());
                        return true;
                    }
                },
                new Result
                ...
                new Result
                {
                    ...
                    Action = c =>
                    {
                        ...
                        _ = Context.API.ReloadAllPluginData().ContinueWith(_ =>
                            Context.API.ShowMsg(
                                Localize.creta_plugin_sys_dlgtitle_success(),
                                Localize.creta_plugin_sys_dlgtext_all_applicableplugins_reloaded()),
                ...
                new Result
                {
                    ...
                    Action = c =>
                    {
                        ...
                        {
                            Context.API.ChangeQuery($"{ThemeSelector.Keyword}{Flow.Launcher.Plugin.Query.ActionKeywordSeparator}");
                        }
                        else
                        {
                            Context.API.ChangeQuery($"{query.ActionKeyword}{Flow.Launcher.Plugin.Query.ActionKeywordSeparator}{ThemeSelector.Keyword}{Flow.Launcher.Plugin.Query.ActionKeywordSeparator}");
                        }
                        return false;
                    }
                }
        ...
        {
            return Localize.creta_plugin_sys_plugin_name();
        }

        public string GetTranslatedPluginDescription()
        {
            return Localize.creta_plugin_sys_plugin_description();
        }
