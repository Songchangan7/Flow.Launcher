...
namespace Creta.Plugin.Url
{
    public class Main : IPlugin, IPluginI18n, ISettingProvider
    {
        ...
        public List<Result> Query(Query query)
        {
            ...
            if (IsURL(raw))
            {
                ...
                [
                    ...
                    {
                        Title = raw,
                        SubTitle = Localize.creta_plugin_url_open_url(raw),
                        ...
                        Action = _ =>
                        {
                            ...
                            {
                                Context.API.ShowMsgError(Localize.creta_plugin_url_cannot_open_url(raw));
                                return false;
                            }
                        }
                    }
        ...
        {
            return Localize.creta_plugin_url_plugin_name();
        }

        public string GetTranslatedPluginDescription()
        {
            return Localize.creta_plugin_url_plugin_description();
        }
