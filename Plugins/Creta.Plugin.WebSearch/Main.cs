    ...
    public class Main : IAsyncPlugin, ISettingProvider, IPluginI18n, IResultUpdated, IContextMenu
    {
        ...
        public async Task<List<Result>> QueryAsync(Query query, CancellationToken token)
        {
                                                                                     ...
                                                                                     && o.Enabled))
            {
                ...
                var title = keyword;
                string subtitle = _context.API.GetTranslation("creta_plugin_websearch_search") + " " + searchSource.Title;
        ...
        public List<Result> LoadContextMenus(Result selected)
        {
            ...
            return new List<Result>() {
                new Result
                {
                    Title = _context.API.GetTranslation("creta_plugin_websearch_copyurl_title"),
                    SubTitle = _context.API.GetTranslation("creta_plugin_websearch_copyurl_subtitle"),
        ...
        {
            return _context.API.GetTranslation("creta_plugin_websearch_plugin_name");
        }

        public string GetTranslatedPluginDescription()
        {
            return _context.API.GetTranslation("creta_plugin_websearch_plugin_description");
        }
