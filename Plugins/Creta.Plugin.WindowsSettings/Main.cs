...
using Creta.Plugin.WindowsSettings.Classes;
using Creta.Plugin.WindowsSettings.Helper;
using Creta.Plugin.WindowsSettings.Properties;

namespace Creta.Plugin.WindowsSettings
{
    /// <summary>
