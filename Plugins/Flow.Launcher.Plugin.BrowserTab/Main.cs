...
using System.Linq;
using Flow.Launcher.Plugin.BrowserTab.Commands;
using Flow.Launcher.Plugin.SharedModels;

namespace Flow.Launcher.Plugin.BrowserTab;
...
public class Main : IPlugin, IPluginI18n
{
            ...
            .Select(tab =>
            {
                ...
                return new Result
                {
                    ...
                    SubTitle = string.IsNullOrWhiteSpace(tab.Url)
                        ? Localize.flowlauncher_plugin_browsertab_jump_to_tab()
                        : $"{Localize.flowlauncher_plugin_browsertab_jump_to_tab()} - {tab.Url}",
                    IcoPath = IcoPath,
    ...
    {
        return Localize.flowlauncher_plugin_browsertab_plugin_name();
    }

    public string GetTranslatedPluginDescription()
    {
        return Localize.flowlauncher_plugin_browsertab_plugin_description();
    }
