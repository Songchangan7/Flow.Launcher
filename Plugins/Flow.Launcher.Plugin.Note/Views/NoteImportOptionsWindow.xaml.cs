...
public partial class NoteImportOptionsWindow
{
    ...
    public NoteImportOptionsWindow(NotesTextImportSplitMode suggestedSplitMode, bool showMarkdownHeadingOption)
    {
        ...
        ConfirmButton.Content = Localize.flowlauncher_plugin_note_settings_notes_import_confirm();

        AddSplitOption(
            NotesTextImportSplitMode.EntireFile,
            Localize.flowlauncher_plugin_note_settings_notes_import_split_entire_file(),
            suggestedSplitMode);
        AddSplitOption(
            NotesTextImportSplitMode.DashSeparator,
            Localize.flowlauncher_plugin_note_settings_notes_import_split_dash_separator(),
            suggestedSplitMode);
        AddSplitOption(
            NotesTextImportSplitMode.BlankLine,
            Localize.flowlauncher_plugin_note_settings_notes_import_split_blank_line(),
            suggestedSplitMode);
        ...
        if (showMarkdownHeadingOption)
        {
            AddSplitOption(
                ...
                Localize.flowlauncher_plugin_note_settings_notes_import_split_markdown_heading(),
                suggestedSplitMode);
        }
    }
